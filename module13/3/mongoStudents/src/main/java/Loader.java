public class Loader {
    public static void main(String[] args) {
        ...
        System.out.println("Имена самых молодых студентов: " + parseToMongo.getNameOfYoung());
        System.out.println("Курсы самого старого студента: " + parseToMongo.getCoursesOfOldStudent());
    }
}
